...
export const onFilterByFloor = (param, filteredData) => {
  if (param === "all") return filteredData;
  else return filteredData.filter(room => room.floor === param);
};
...
export const onFilterByCapacity = (params, filteredData) => {
  ...
  if (roomsByCapacity.length > 0) return roomsByCapacity;
  else return filteredData;
};

// Filter data by availability
export const onFilterByAvailability = (params, filteredData) => {
